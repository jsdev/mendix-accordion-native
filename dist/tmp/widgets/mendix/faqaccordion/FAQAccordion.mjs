...
async function swapSortOrders(item1, item2, orderOrAttribute, order2OrDataSource, dataSource, successMessage) {
    ...
    debugLog("swapSortOrders - item1 current value:", mxObj1.get(FAQ_ATTRIBUTES.SORT_ORDER)?.toString());
    debugLog("swapSortOrders - item2 current value:", mxObj2.get(FAQ_ATTRIBUTES.SORT_ORDER)?.toString());
    // Swap the values
    ...
    debugLog("swapSortOrders - item1 new value:", mxObj1.get(FAQ_ATTRIBUTES.SORT_ORDER)?.toString());
    debugLog("swapSortOrders - item2 new value:", mxObj2.get(FAQ_ATTRIBUTES.SORT_ORDER)?.toString());
    // Commit both objects
    return new Promise((resolve, reject) => {
...
function useFAQActions({ dataSourceType, dataSource, sortOrderAttribute, editState, onSaveAction, onDeleteAction, onCreateAction, attributeOverrides }) {
    ...
    const handleSaveNew = useCallback(async (summary, content, format, sortOrder) => {
        ...
        try {
            ...
            await commitObject(newItem, dataSource);
...
function FAQAccordion(props) {
    const { dataSourceType, faqItems, dataSource, defaultExpandAll, showToggleButton, toggleButtonText, animationDuration, allowEditing, editorRole, onSaveAction, onDeleteAction, onCreateAction, sortOrderAttribute, debugMode, 
